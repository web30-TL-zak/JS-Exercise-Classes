...
class Student extends Lambdasian {
  ...
  listSubjects(){
    ...
    return `Loving ${stringOfSubjects}!`;
  }
...
const zak = new Student({
  name: 'Zak',
  age: 25,
  location: "Ohio",
  previousBackground: 'Lambda',
  className: 'WEB26',
...
brit.givePoints(zak)
console.log('STUDENT GRADE', zak.grade)
console.log(brit.graduate(zak))
